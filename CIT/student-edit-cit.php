		...
		<form name="form1" method="post" >
		  <div align="center">
		    ...
		    <table border="0" align="center" >
              <tr >
                <td width="161" height="34" ><div align="right" class="style3">Course Year and Section </div></td>
                <td width="197" ><input type="text" name="txtcourse" id="txtcourse" value="<?php echo $course_yrSec ?>" /></td>
                <td width="149"><span class="style20"><?php echo $flagcourse; ?>&nbsp;</span></td>
              </tr>
              <tr >
                <td height="42" ><div align="right" class="style3">Major</div></td>
