...
?>
                 ...
                 <span class="style32 style3"><span class="style10">Automated Time Table Generator <br />
                    <strong>Indian Institute of Technology </strong><br /> 
                    Jodhpur, Rajasthan </span><br />
                    <br /> 
...
if (!$result) 
		...
		//	$t = $_REQUEST[$t];
				...
				$pT =$_REQUEST['pT'];
				$result = mysqli_query($conn,"SELECT * FROM profile HAVING teacher_id='$pT'");
...
if (!$result) 
		...
		die("Query to show fields from table failed");
			...
			$teacher = mysqli_result($result,$i,"teacher_name");
			$acad = mysqli_result($result,$i,"acad_rank");
 ...
 and sched.year_id=school_yr.year_id HAVING teacher_id='$pT' and sem_id='$psem' and year_id='$pSy'
	...
	<tr>
                ...
                <table width="723" border="1" align="center">
                  <tr>
                    <td width="90"><div align="center" class="style3">TIME</div></td>
                    <td width="122"><div align="center" class="style3">MONDAY</div></td>
                    <td width="121"><div align="center" class="style3">TUESDAY</div></td>
